...
$avg_rating = ($avg_row['avg_rating'] !== null) 
  ? round($avg_row['avg_rating'], 1) 
  : null;
...
<div class="recipe-container">
    <a href="recipes.php" class="back-link">← Back to Recipes</a>
    <h1 class="recipe-title"><?= htmlspecialchars($recipe['title']) ?></h1>
    <p class="avg-rating">⭐ Average Rating: <?= $avg_rating ?? "No ratings yet" ?></p>
